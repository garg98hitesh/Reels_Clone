...
function UploadFile(props) {
    ...
    const handleChange = async (file) => {
        ...
        if (file.size / (1024 * 1024) > 100) { //File size is in bytes and to convert it into MB we divide by 1024*1024. In this condition we are checking whether file size is greater than 100 or not
